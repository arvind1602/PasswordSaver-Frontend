...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post("https://passwordsaver-backend.onrender.com/api/users/create", form);

      // Send email code
      await axios.post("https://passwordsaver-backend.onrender.com/api/email/send-code", {
  ...
  const handleVerify = async () => {
    try {
      const res = await axios.post("https://passwordsaver-backend.onrender.com/api/email/verify-code", {
        email: form.email,
  ...
  useEffect(() => {
    (async () => {
      try {
        await axios.get("https://passwordsaver-backend.onrender.com/api/user/profile", { withCredentials: true });
        setIsLoggedIn(true);
      } catch {
        setIsLoggedIn(false);
      }
