    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f0c29] via-[#302b63] to-[#24243e] text-white px-4 py-10 pt-25">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20 text-left">
          <FeatureCard icon={<FaLock />} color="text-cyan-400" title="100% Encrypted" desc="Top-grade encryption keeps your data private and safe." />
          <FeatureCard icon={<FaRocket />} color="text-fuchsia-400" title="Fast & Reliable" desc="Access and manage your passwords instantly." />
          <FeatureCard icon={<FaShieldAlt />} color="text-yellow-400" title="Zero Tracking" desc="We don’t sell data. We don’t track. We respect privacy." />
        </div>

        {/* 🔍 About Vault */}
        <div className="bg-white/5 backdrop-blur-lg border border-gray-700 rounded-2xl p-8 mb-20 text-left">
          <h2 className="text-3xl font-bold mb-4 text-white">What is PasswordSaver?</h2>
          <p className="text-gray-300 leading-relaxed">
            PasswordSaver is a secure password management system that allows you
            to save login details for various services in one encrypted vault. 
            With military-grade protection and sleek design, your secrets stay yours.
          </p>
        </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left">
            <FeatureCard icon={<FaUserShield />} color="text-blue-400" title="Create Account" desc="Sign up and set up your secure vault." />
            <FeatureCard icon={<FaLock />} color="text-pink-400" title="Save Passwords" desc="Add entries for your favorite apps & websites." />
            <FeatureCard icon={<FaThumbsUp />} color="text-green-400" title="Access Anytime" desc="Log in from any device securely and instantly." />
          </div>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-lg border border-gray-700 rounded-2xl p-8 mb-20">
          ...
          <p className="text-gray-400 italic text-center">
            “I’ve finally stopped forgetting my passwords! PasswordSaver is life-changing.” – A Happy User
          </p>
        </div>
